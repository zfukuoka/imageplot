...
def viewer():
  ...
  RED_LAB_A = [
    0.0, 4.339012, 12.0952835, 23.040688, 29.08194,
    33.762222, 38.285065, 42.67778, 46.960007, 51.14662,
    55.24913, 59.27684, 63.237152, 67.13638, 70.97974,
    74.77173]
  RED_LAB_B = [
    0.0, 1.5270233, 4.256687, 8.710579, 14.891321,
    20.972176, 26.528345, 31.582932, 36.149002, 40.233482,
    43.839302, 47.06043, 50.204575, 53.300194, 56.351486,
    59.361996]
  GREEN_LAB_A = [
    0.0, -6.9461594, -19.071365, -27.179245, -32.656616,
    -37.91217, -42.990967, -47.923584, -52.732193, -57.43344,
    -62.040222, -66.56296, -71.01007, -75.38858, -79.70438,
    -83.962494]
  GREEN_LAB_B = [
    0.0, 4.6055145, 12.721571, 21.063679, 27.323513,
    31.878716, 36.149246, 40.29689, 44.340237, 48.29329,
    52.16696, 55.969925, 59.709312, 63.391, 67.019966,
    70.600426]
  BLUE_LAB_A = [
    0.0, 2.3195648, 6.4659576, 13.231476, 22.874817,
    31.837372, 38.03235, 42.424637, 46.681473, 50.84326,
    54.92148, 58.925247, 62.86209, 66.73819, 70.55878,
    74.32826]
  BLUE_LAB_B = [
    0.0, -8.712122, -21.846209, -33.910652, -44.532593,
    -53.811886, -61.792637, -68.89394, -75.80669, -82.56508,
    -89.18772, -95.6895, -102.08258, -108.37702, -114.581314,
    -120.70267]
  CYAN_LAB_A = [
    0.0, -4.6265945, -12.092834, -15.477104, -18.59616,
    -21.588928, -24.481018, -27.289886, -30.028107, -32.70523,
    -35.328552, -37.90399, -40.4364, -42.929688, -45.3873,
    -47.812042]
  CYAN_LAB_B = [
    0.0, -4.1066093, -8.131218, -10.323193, -12.403595,
    -14.399757, -16.328781, -18.202278, -20.028687, -21.814316,
    -23.564056, -25.28189, -26.970963, -28.634018, -30.273224,
    -31.890533]
  MAGENTA_LAB_A = [
    0.0, 6.658577, 18.56115, 29.71354, 35.736282,
    41.487457, 47.04521, 52.443024, 57.705124, 62.849686,
    67.890915, 72.840164, 77.706696, 82.49808, 87.220856,
    91.880554]
  MAGENTA_LAB_B = [
    0.0, -7.1850986, -17.406364, -24.558186, -29.52119,
    -34.272163, -38.86332, -43.32238, -47.669296, -51.91915,
    -56.08364, -60.17215, -64.19229, -68.1504, -72.05182,
    -75.90109]
  YELLOW_LAB_A = [
    0.0, -2.6071472, -5.7919083, -7.3532715, -8.835159,
    -10.257019, -11.631088, -12.965607, -14.266541, -15.538422,
    -16.78482, -18.008392, -19.211578, -20.396149, -21.563812,
    -22.71579]
  YELLOW_LAB_B = [
    0.0, 6.132538, 16.143116, 24.99825, 31.476112,
    36.546013, 41.441784, 46.196682, 50.832, 55.363815,
    59.80462, 64.16437, 68.45123, 72.67195, 76.83223,
    80.9369]
  ...
  ax_plot3.plot(
    RED_LAB_A, RED_LAB_B, color='#FF0000',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
    GREEN_LAB_A, GREEN_LAB_B, color='#00FF00',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
    BLUE_LAB_A, BLUE_LAB_B, color='#0000FF',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
    CYAN_LAB_A, CYAN_LAB_B, color='#00FFFF',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
    MAGENTA_LAB_A, MAGENTA_LAB_B, color='#FF00FF',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
    YELLOW_LAB_A, YELLOW_LAB_B, color='#C0C000',
    linestyle="--", alpha=1.0, zorder=-5.0)
  ax_plot3.plot(
...
# ])
# test_np = np.array([
#   [[0,0,0], [16,0,16], [32,0,32], [48,0,48]],
#   [[64,0,64], [80,0,80], [96,0,96], [112,0,112]],
#   [[128,0,128], [144,0,144], [160,0,160], [176,0,176]],
#   [[192,0,192], [208,0,208], [224,0,224], [240,0,240]]
# ])
